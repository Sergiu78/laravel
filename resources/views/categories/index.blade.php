...
<link rel="stylesheet" type="text/css" href="styles/categories_responsive.css">
	...
	<div class="home">
		<div class="home_container">
			<div class="home_background" style="background-image:url('/public/images/{{$cat->img}}')"></div>
				...
				<div class="col">
					...
					<div class="product_grid">
						...
						<div class="product">
							...
							<div class="product_extra product_new"><a href="{{ route('showCategory', $product->categories['alias']) }}">{{ $product->categories['title'] }}</a></div>
							<div class="product_content">
								<div class="product_title"><a href="{{ route('show', ['category', $product->id])}}">{{ $product->title }}</a></div>
