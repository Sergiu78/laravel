			...
			<div class="row details_row">
				...
				<div class="col-lg-6">
					...
					@php
						...
						@endphp
						<div class="details_image_large"><img src="/public/images/{{ $image }}" alt="{{ $item->title }}"><div class="product_extra product_new"><a href="categories.html">New</a></div></div>
						<div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
							@if($image == 'no_images.png')
								
							@else
								@foreach($item->images as $img)
									@if($loop->first)
										<div class="details_image_thumbnail active" data-image="/public/images/{{ $img['img'] }}"><img src="/public/images/{{ $img['img'] }}" alt="{{ $item->title }}"></div>
									@else
										<div class="details_image_thumbnail" data-image="/public/images/{{ $img['img'] }}"><img src="/public/images/{{ $img['img'] }}" alt="{{ $item->title }}">
									@endif
								@endforeach
				...
				<div class="col-lg-6">
					<div class="details_content">
						...
						<div class="in_stock_container">
							...
							<span>In Stock</span>
							@else
							<span style="color: #cc000;">None</span>
